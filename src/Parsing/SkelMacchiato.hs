...
module Parsing.SkelMacchiato where
...
transIdent :: AbsMacchiato.Ident -> Result
transIdent x = case x of
  AbsMacchiato.Ident string -> failure x
...
transFnDef x = case x of
  AbsMacchiato.FunDef _ type_ ident args block -> failure x

transArg :: Show a => AbsMacchiato.Arg' a -> Result
transArg x = case x of
  AbsMacchiato.ArgVal _ type_ ident -> failure x
...
transStmt x = case x of
  ...
  AbsMacchiato.Ass _ ident expr -> failure x
  AbsMacchiato.Incr _ ident -> failure x
  AbsMacchiato.Decr _ ident -> failure x
  AbsMacchiato.Ret _ expr -> failure x
  AbsMacchiato.RetNone _ -> failure x
...
transItem x = case x of
  AbsMacchiato.NoInit _ ident -> failure x
  AbsMacchiato.Init _ ident expr -> failure x
