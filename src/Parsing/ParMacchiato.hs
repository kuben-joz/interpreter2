...
#endif
newtype HappyWrap4 = HappyWrap4 ((AbsMacchiato.BNFC'Position, AbsMacchiato.Ident))
happyIn4 :: ((AbsMacchiato.BNFC'Position, AbsMacchiato.Ident)) -> (HappyAbsSyn )
happyIn4 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap4 x)
{-# INLINE happyIn4 #-}
happyOut4 :: (HappyAbsSyn ) -> HappyWrap4
happyOut4 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut4 #-}
newtype HappyWrap5 = HappyWrap5 ((AbsMacchiato.BNFC'Position, Integer))
happyIn5 :: ((AbsMacchiato.BNFC'Position, Integer)) -> (HappyAbsSyn )
happyIn5 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap5 x)
{-# INLINE happyIn5 #-}
happyOut5 :: (HappyAbsSyn ) -> HappyWrap5
happyOut5 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut5 #-}
newtype HappyWrap6 = HappyWrap6 ((AbsMacchiato.BNFC'Position, String))
happyIn6 :: ((AbsMacchiato.BNFC'Position, String)) -> (HappyAbsSyn )
...
{-# INLINE happyOut17 #-}
newtype HappyWrap18 = HappyWrap18 ((AbsMacchiato.BNFC'Position, [AbsMacchiato.Type]))
happyIn18 :: ((AbsMacchiato.BNFC'Position, [AbsMacchiato.Type])) -> (HappyAbsSyn )
happyIn18 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap18 x)
{-# INLINE happyIn18 #-}
happyOut18 :: (HappyAbsSyn ) -> HappyWrap18
happyOut18 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut18 #-}
newtype HappyWrap19 = HappyWrap19 ((AbsMacchiato.BNFC'Position, AbsMacchiato.Expr))
happyIn19 :: ((AbsMacchiato.BNFC'Position, AbsMacchiato.Expr)) -> (HappyAbsSyn )
happyIn19 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap19 x)
{-# INLINE happyIn19 #-}
happyOut19 :: (HappyAbsSyn ) -> HappyWrap19
happyOut19 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut19 #-}
newtype HappyWrap20 = HappyWrap20 ((AbsMacchiato.BNFC'Position, AbsMacchiato.Expr))
happyIn20 :: ((AbsMacchiato.BNFC'Position, AbsMacchiato.Expr)) -> (HappyAbsSyn )
...
{-# INLINE happyOut21 #-}
newtype HappyWrap22 = HappyWrap22 ((AbsMacchiato.BNFC'Position, AbsMacchiato.Expr))
happyIn22 :: ((AbsMacchiato.BNFC'Position, AbsMacchiato.Expr)) -> (HappyAbsSyn )
...
{-# INLINE happyOut23 #-}
newtype HappyWrap24 = HappyWrap24 ((AbsMacchiato.BNFC'Position, AbsMacchiato.Expr))
happyIn24 :: ((AbsMacchiato.BNFC'Position, AbsMacchiato.Expr)) -> (HappyAbsSyn )
happyIn24 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap24 x)
{-# INLINE happyIn24 #-}
happyOut24 :: (HappyAbsSyn ) -> HappyWrap24
happyOut24 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut24 #-}
newtype HappyWrap25 = HappyWrap25 ((AbsMacchiato.BNFC'Position, AbsMacchiato.Expr))
happyIn25 :: ((AbsMacchiato.BNFC'Position, AbsMacchiato.Expr)) -> (HappyAbsSyn )
happyIn25 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap25 x)
{-# INLINE happyIn25 #-}
happyOut25 :: (HappyAbsSyn ) -> HappyWrap25
happyOut25 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut25 #-}
newtype HappyWrap26 = HappyWrap26 ((AbsMacchiato.BNFC'Position, [AbsMacchiato.Expr]))
happyIn26 :: ((AbsMacchiato.BNFC'Position, [AbsMacchiato.Expr])) -> (HappyAbsSyn )
happyIn26 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap26 x)
{-# INLINE happyIn26 #-}
happyOut26 :: (HappyAbsSyn ) -> HappyWrap26
happyOut26 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut26 #-}
newtype HappyWrap27 = HappyWrap27 ((AbsMacchiato.BNFC'Position, AbsMacchiato.AddOp))
happyIn27 :: ((AbsMacchiato.BNFC'Position, AbsMacchiato.AddOp)) -> (HappyAbsSyn )
happyIn27 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap27 x)
{-# INLINE happyIn27 #-}
happyOut27 :: (HappyAbsSyn ) -> HappyWrap27
happyOut27 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut27 #-}
newtype HappyWrap28 = HappyWrap28 ((AbsMacchiato.BNFC'Position, AbsMacchiato.MulOp))
happyIn28 :: ((AbsMacchiato.BNFC'Position, AbsMacchiato.MulOp)) -> (HappyAbsSyn )
happyIn28 x = Happy_GHC_Exts.unsafeCoerce# (HappyWrap28 x)
{-# INLINE happyIn28 #-}
happyOut28 :: (HappyAbsSyn ) -> HappyWrap28
happyOut28 x = Happy_GHC_Exts.unsafeCoerce# x
{-# INLINE happyOut28 #-}
newtype HappyWrap29 = HappyWrap29 ((AbsMacchiato.BNFC'Position, AbsMacchiato.RelOp))
happyIn29 :: ((AbsMacchiato.BNFC'Position, AbsMacchiato.RelOp)) -> (HappyAbsSyn )
...
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_pProgram_internal","Ident","Integer","String","Program","FnDef","ListFnDef","Arg","ListArg","Block","ListStmt","Stmt","Item","ListItem","Type","ListType","Expr6","Expr5","Expr4","Expr3","Expr2","Expr1","Expr","ListExpr","AddOp","MulOp","RelOp","'!'","'!='","'%'","'&&'","'('","')'","'*'","'+'","'++'","','","'-'","'--'","'/'","';'","'<'","'<='","'='","'=='","'>'","'>='","'boolean'","'else'","'false'","'if'","'int'","'return'","'string'","'true'","'void'","'while'","'{'","'||'","'}'","L_Ident","L_integ","L_quoted","%eof"]
...
happyReduction_1 happy_x_1
	...
	happyIn4
		 ((uncurry AbsMacchiato.BNFC'Position (tokenLineCol happy_var_1), AbsMacchiato.Ident (tokenText happy_var_1))
	)}
