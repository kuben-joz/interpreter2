...
%token
  ...
  '>'        { PT _ (TS _ 21)    }
  '>='       { PT _ (TS _ 22)    }
  'DIM_NUM'  { PT _ (TS _ 23)    }
  'LENGTH'   { PT _ (TS _ 24)    }
  'MAX_VAL'  { PT _ (TS _ 25)    }
  'MIN_VAL'  { PT _ (TS _ 26)    }
  '['        { PT _ (TS _ 27)    }
  '[]'       { PT _ (TS _ 28)    }
  ']'        { PT _ (TS _ 29)    }
...
Stmt
  ...
  | UIdent '++' ';' { (fst $1, AbsMacchiato.Incr (fst $1) (snd $1)) }
  | UIdent '--' ';' { (fst $1, AbsMacchiato.Decr (fst $1) (snd $1)) }
  ...
  | 'return' ';' { (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1), AbsMacchiato.RetNone (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1))) }
  ...
  | 'break' ';' { (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1), AbsMacchiato.Break (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1))) }
  | 'continue' ';' { (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1), AbsMacchiato.Cont (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1))) }
...
Type
  ...
  | 'boolean' { (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1), AbsMacchiato.Bool (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1))) }
  | 'void' { (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1), AbsMacchiato.Void (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1))) }
  | Type ListDimBra { (fst $1, AbsMacchiato.Arr (fst $1) (snd $1) (snd $2)) }
...
Expr6
  ...
  | 'new' Type ListDimAcc ListDimEmpty { (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1), AbsMacchiato.ENewArr (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1)) (snd $2) (snd $3) (snd $4)) }
...
DimAcc
  : '[' Expr ']' { (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1), AbsMacchiato.EDimAcc (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1)) (snd $2)) }

DimEmpty :: { (AbsMacchiato.BNFC'Position, AbsMacchiato.DimEmpty) }
DimEmpty
  : '[]' { (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1), AbsMacchiato.EDimEmpty (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1))) }
...
ListDimEmpty :: { (AbsMacchiato.BNFC'Position, [AbsMacchiato.DimEmpty]) }
ListDimEmpty
  : {- empty -} { (AbsMacchiato.BNFC'NoPosition, []) }
  | DimEmpty ListDimEmpty { (fst $1, (:) (snd $1) (snd $2)) }
...
KeyWord
  ...
  | 'MIN_VAL' { (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1), AbsMacchiato.KeyWordMinVal (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1))) }
  | 'DIM_NUM' { (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1), AbsMacchiato.KeyWordDimNum (uncurry AbsMacchiato.BNFC'Position (tokenLineCol $1))) }
